<x-app-layout>
    <x-slot name="header">Laporan Nasi Box</x-slot>
    <h4 class="fw-bold mb-3">Laporan</h4>
    @include('laporan.partials.tabs')
    <div class="card border-0 shadow-sm mb-4"><div class="card-body">
        <form method="GET" action="{{ route('laporan.nasibox') }}" class="row g-2 align-items-end">
    ...
    <div class="card border-0 shadow-sm"><div class="card-header bg-white py-3"><h6 class="fw-semibold mb-0">Daftar Pesanan Nasi Box</h6></div>
        <div class="card-body p-0"><div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr>
                    <th class="ps-4">Tanggal</th><th>Pelanggan</th><th>Paket</th><th>Qty Box</th><th>Status</th><th class="text-end pe-4">Total</th>
                </tr></thead>
                <tbody>
