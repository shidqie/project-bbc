        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-[8px]">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('bahan-baku.update', $bahanBaku->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        
                        <div>
                            <label for="nama" class="block font-medium text-sm text-gray-700">Nama Bahan</label>
                            <input type="text" name="nama" id="nama" class="mt-1 block w-full border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6] rounded-[4px] shadow-sm" value="{{ old('nama', $bahanBaku->nama) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="satuan" id="satuan" class="mt-1 block w-full border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6] rounded-[4px] shadow-sm" value="{{ old('satuan', $bahanBaku->satuan) }}" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="stok" id="stok" class="mt-1 block w-full border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6] rounded-[4px] shadow-sm" value="{{ old('stok', $bahanBaku->stok) }}" min="0" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="batas_minimum" id="batas_minimum" class="mt-1 block w-full border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6] rounded-[4px] shadow-sm" value="{{ old('batas_minimum', $bahanBaku->batas_minimum) }}" min="0" required>
