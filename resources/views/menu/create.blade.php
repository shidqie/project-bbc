                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="harga" id="harga" class="mt-1 block w-full border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6] rounded-[4px] shadow-sm" value="{{ old('harga') }}" min="0" required>
