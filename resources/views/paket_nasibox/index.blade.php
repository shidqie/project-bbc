            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-[8px]">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium" style="font-family: 'Google Sans', sans-serif;">Daftar Paket Nasi Box</h3>
                        <a href="{{ route('paket-nasibox.create') }}" class="px-4 py-2 bg-[#3B82F6] hover:bg-blue-600 text-white rounded-[4px] transition ease-in-out duration-150 shadow-sm">
                            + Tambah Data
                        </a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4 text-right space-x-2">
                                        <a href="{{ route('paket-nasibox.edit', $item->id) }}" class="text-[#8B5CF6] hover:text-purple-700 font-medium">Edit</a>
                                        <form action="{{ route('paket-nasibox.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Hapus paket ini?');">
                                            @csrf
                                            @method('DELETE')
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="p-4 text-center text-gray-500">Belum ada paket nasi box.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
