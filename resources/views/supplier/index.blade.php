            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-[8px]">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium" style="font-family: 'Google Sans', sans-serif;">Daftar Supplier</h3>
                        <a href="{{ route('supplier.create') }}" class="px-4 py-2 bg-[#3B82F6] hover:bg-blue-600 text-white rounded-[4px] transition ease-in-out duration-150 shadow-sm">
                            + Tambah Data
                        </a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4 text-right space-x-2">
                                        <a href="{{ route('supplier.edit', $item->id) }}" class="text-[#8B5CF6] hover:text-purple-700 font-medium">Edit</a>
                                        <form action="{{ route('supplier.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Hapus supplier ini?');">
                                            @csrf
                                            @method('DELETE')
